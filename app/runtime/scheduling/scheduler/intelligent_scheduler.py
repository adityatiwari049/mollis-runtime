...
class IntelligentScheduler(BaseScheduler):
    ...
    def __init__(
        ...
        Args:
            queue (BaseTaskQueue): Target task queue.
            worker_pool (WorkerPool): Worker thread pool.
            admission_controller (Optional[AdmissionController]): Admission guard policy.
        """
        self._queue = queue
